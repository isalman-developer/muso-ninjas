...
export default {
  ...
  setup(props) {
    // here playlist is an alias to access document, from here document will be accessivble with 
    ...
    const ownership = computed(() => {
      // here we are checking truthy and falsy values
      // first condition is that playlist must have value
      // second condition is that user must have value
      // third condition is that user.id == playlist.userId
      return (
